    ...
    override fun transferir(
        ...
        dataSource.getUser(cedulaDestino)
            .addOnSuccessListener { snapshotDestino ->
                ...
                val saldoDestinoActual = snapshotDestino.child("saldo").value?.toString()?.toDoubleOrNull() ?: 0.0
                ...
                dataSource.getUser(cedulaOrigen)
                    .addOnSuccessListener { snapshotOrigen ->
                        ...
                        val nuevoSaldoDestino = saldoDestinoActual + monto
                            ...
                            .addOnSuccessListener {
                                ...
                                dataSource.actualizarSaldo(cedulaDestino, nuevoSaldoDestino)
                                    .addOnSuccessListener {
                                        ...
                                        onResult(false, "Error al actualizar el saldo del destinatario")
                                    }
